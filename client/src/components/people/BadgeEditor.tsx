  ...
  return (
    <div className="border-t border-gray-200 dark:border-gray-600 pt-4">
      <button
        ...
        className="w-full flex items-center justify-between mb-3 hover:bg-gray-50 dark:hover:bg-gray-700 rounded p-2 -m-2 transition-colors"
      >
      ...
      {isExpanded && (
        <>
          ...
          <div className="space-y-3">
            {/* Badge Text */}
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Badge Text</label>
              <div className="mt-1">
                <input
                  type="text"
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-2">
                <button
                  ...
                  title="Default"
                >
                  <span className="text-xs font-medium text-gray-600 dark:text-gray-300">Default</span>
                </button>
                {BADGE_ICON_OPTIONS.map((option) => (
                  ...
                  >
                    ...
                    <span className="text-xs mt-1 text-gray-600 dark:text-gray-400">{option.label}</span>
                  </button>
                ))}
              </div>
              <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">
            ...
            {/* Badge Color */}
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Badge Color</label>
              <div className="flex items-center space-x-3">
                ...
                <input
                  ...
                  onChange={(e) => onBadgeChange({ badgeColor: e.target.value })}
                  className="block w-32 rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm uppercase font-mono"
                  placeholder="Default"
                  maxLength={7}
                />
              </div>
