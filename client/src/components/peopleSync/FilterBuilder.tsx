...
export default function FilterBuilder({ metadata, value, onChange, disabled = false }: FilterBuilderProps) {
  ...
  const cancelPending = () => { const origin = pendingOrigin.current; pendingOrigin.current = null; setPending(null); setRestoreConstructionKey(origin); };
