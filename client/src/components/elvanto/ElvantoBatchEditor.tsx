...
import GatheringAutoRemoveControl from '../peopleSync/GatheringAutoRemoveControl';
...
export default function ElvantoBatchEditor({ batch: initialBatch, gatherings, onSaved, onCancel }: ElvantoBatchEditorProps) {
  ...
  const sourceReviewPending = currentBatch?.operationalState === 'source_review_required';
