                            ...
                            <>
                              {locationResults.map((result) => (
                                ...
                                >
                                  ...
                                  {result.population !== null && result.population !== undefined && Number.isFinite(result.population) && (
                                    <div className="text-xs text-gray-500 dark:text-gray-400">
                              ...
                              {locationResults[0]?.source === 'open-meteo' && (
                              ...
                              {locationResults[0]?.source === 'geoapify' && (
                                <div className="px-4 py-2 text-xs text-gray-400 dark:text-gray-500 flex flex-wrap gap-x-1">
                                  <a
